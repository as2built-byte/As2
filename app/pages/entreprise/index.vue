...
/**
 * Enterprise Dashboard - KPIs & Project Calendar
 * 
 * Displays enterprise-specific statistics and a monthly calendar
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <template v-else>
            ...
            <div class="mb-8">
                ...
                <p class="text-slate-500 mt-1">Vue d'ensemble de vos projets et activités</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <div class="bg-white rounded-xl p-5 border border-slate-200 shadow-sm">
                    ...
                    <div class="flex items-center gap-3 mt-1">
                        <span class="text-xs text-blue-600 font-medium">{{ activeMissions }} en cours</span>
                        <span class="text-xs text-slate-400">{{ pendingMissions }} en attente</span>
                    </div>
                </div>
            ...
            <div class="mb-8">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div v-if="projects.length === 0" class="px-6 py-12 text-center border-t border-slate-100">
                        ...
                        <p class="text-sm font-medium text-slate-400">Aucun projet pour le moment</p>
