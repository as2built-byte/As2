    ...
    <div class="auth-container">
        <div class="auth-card slide-up max-w-lg">
            ...
            <div class="form-header">
                <div class="form-header-icon bg-emerald-100 text-emerald-600">
                    <Icon name="heroicons:building-office-2" class="w-7 h-7" />
                </div>
                <div>
                    <h1 class="form-header-title">Inscription Entreprise</h1>
                    <p class="form-header-subtitle">Créez le compte de votre entreprise</p>
                </div>
            </div>
            ...
            <form @submit.prevent="handleSubmit" class="form-section">
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        <Icon name="heroicons:building-office" class="input-icon" />
                        <input
                            id="companyName"
                            ...
                            :class="{ 'input-error': formErrors.companyName }"
                        />
                    </div>
                    <span v-if="formErrors.companyName" class="input-error-message">
                        {{ formErrors.companyName }}
                    </span>
                </div>

                <!-- Section Label for Manager -->
                <div class="pt-2">
