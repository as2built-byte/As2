...
const navigation = {
    ...
    finance: [
        { path: '/admin/transactions', label: 'Transactions', icon: 'heroicons:banknotes', disabled: true }
    ]
}
        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 sidebar-scroll">
                ...
                <div class="mt-8">
                    ...
                    <div class="space-y-1">
                        <div 
                            v-for="item in navigation.finance" 
                            :key="item.path"
                            class="nav-item nav-item-disabled"
                            :title="sidebarCollapsed ? item.label : undefined"
                        >
...
<style scoped>
.nav-item {
    @apply flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-400 transition-all duration-200 cursor-pointer;
}
